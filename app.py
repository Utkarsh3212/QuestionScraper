...
def load_index_doc():
    documents = []
    with open('Scraper/QDATA/index.txt', 'r') as f:
...
def load_link_of_qs():
    with open("Scraper/QDATA/qIndex.txt", "r") as f:
        links = f.readlines()
...
indexed_doc=load_index_doc()
qLinks=load_link_of_qs()
...
def calculate_sorted_order_of_documents(query_terms):
    ...
    for document_index in potential_documents:
        ans.append({"Question Link":qLinks[int(document_index)],"Score":potential_documents[document_index]})
